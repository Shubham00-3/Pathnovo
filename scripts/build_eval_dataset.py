...
def main() -> None:
    ...
    registry = {
        ...
        "PID-SYN2-A": {
            ...
            "revision_label": "A",
            "path": "data/samples/synthetic_secondary/export_rev_a.pdf",
            "media_type": "application/pdf",
            "display_name": "Synthetic Export Rev A",
        },
        "PID-SYN2-B": {
            "underlying_document_id": "DOC-SYN-EXPORT",
            "revision_label": "B",
            "path": "data/samples/synthetic_secondary/export_rev_b.pdf",
            "media_type": "application/pdf",
            "display_name": "Synthetic Export Rev B",
        },
        "PID-CAD-A": {
